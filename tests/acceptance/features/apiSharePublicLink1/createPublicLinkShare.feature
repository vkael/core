...
Feature: create a public link share
  ...
  Scenario Outline: Create a new public link share of a file with edit permissions
    ...
    And uploading content to a public link shared file <upload_works_or_not> using the <public-webdav-api-version> public WebDAV API

    @notToImplementOnOCIS @issue-ocis-2079
    Examples:
      | ocs_api_version | ocs_status_code | public-webdav-api-version | requested_permissions     | granted_permissions | upload_works_or_not |
      | 1               | 100             | old                       | read,update,create,delete | read,update         | should work         |
      | 2               | 200             | old                       | read,update,create,delete | read,update         | should work         |
      | 1               | 100             | old                       | all                       | read                | should not work     |
      | 2               | 200             | old                       | all                       | read                | should not work     |

    @issue-ocis-reva-292
    Examples:
      | ocs_api_version | ocs_status_code | public-webdav-api-version | requested_permissions     | granted_permissions | upload_works_or_not |
      | 1               | 100             | new                       | read,update,create,delete | read,update         | should work         |
      | 2               | 200             | new                       | read,update,create,delete | read,update         | should work         |
      | 1               | 100             | new                       | all                       | read                | should not work     |
      | 2               | 200             | new                       | all                       | read                | should not work     |
